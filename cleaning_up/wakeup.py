...
def FullTextQuery(calendar_service):
    ...
    rfc3339 = '2015-11-05T21:02:53.108Z'
    print " "
    print "test" ,"Scheduled:",1,"For:",time.strftime('%d-%m-%Y %H:%M',time.localtime(tf_from_timestamp(rfc3339))),"Current Time:",time.strftime('%d-%m-%Y %H:%M',time.localtime())
    ...
    if time.strftime('%d-%m-%Y %H:%M',time.localtime(tf_from_timestamp(rfc3339))) == time.strftime('%d-%m-%Y %H:%M'):
        print "Waking you up!"
        print "---" 
